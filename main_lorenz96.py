from datasets import linear, multiple_lotka_volterra, lorenz96
import logging
import os
from models import rootad
from args import linear_point_args, lv_point_args, lorenz96_point_args
import sys
...
def main(argv):
    ...
    log_file_path = os.path.join(logging_dir, 'lorenz96.log')
    # Set up logging
    ...
    parser = lorenz96_point_args.args_parser()
    ...
    data_class = lorenz96.Lorenz96(options)
