...
from datasets.MSDS import msds
import logging
import os
from models import rootad
from args import linear_point_args, lv_point_args, swat_args, msds_args
import sys
...
def main(argv):
    ...
    log_file_path = os.path.join(logging_dir, 'msds.log')
    # Set up logging
