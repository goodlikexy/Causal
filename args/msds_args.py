...
def args_parser():
    ...
    parser = argparse.ArgumentParser(description='MDSD')
    # Dataset
    parser.add_argument('--preprocessing_data', type=int, default=1)
    parser.add_argument('--data_dir', type=str, default='./datasets/MSDS')
    parser.add_argument('--num_vars', type=int, default=10)
    parser.add_argument('--causal_quantile', type=float, default=0.70)
    parser.add_argument('--shuffle', type=int, default=1)

    # Meta
    parser.add_argument('--seed', type=int, default=9, help='Random seed (default: 42)')
    parser.add_argument('--device', type=str, default='cuda:0')
    parser.add_argument('--dataset_name', type=str, default='MSDS')
