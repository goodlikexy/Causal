...
def args_parser():
    ...
    parser.add_argument('--num_vars', type=int, default=6)
    ...
    parser.add_argument('--data_dir', type=str, default='./datasets/graph_point')
    parser.add_argument('--causal_quantile', type=float, default=0.8)
