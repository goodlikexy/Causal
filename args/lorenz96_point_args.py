...
def args_parser():
    ...
    # Dataset
    parser.add_argument('--T', type=int, default=2000, help='Length of the time series (default: 50)')
    ...
    parser.add_argument('--data_dir', type=str, default='./datasets/lorenz96_point')
    ...
    parser.add_argument('--dataset_name', type=str, default='lorenz96')
