...
class Lorenz96:
    ...
    def get_causal_structure(self):
        ...
        for i in range(self.num_vars):
            ...
            a[((i - 1) < 0) * (self.num_vars - 1) + ((i - 1) >= 0) * (i - 1), i] = 1
        return a
    ...
    def generate_example(self):
        ...
        for i in tqdm(range(self.n), desc='Generating data'):
        ...
        np.save(self.data_dir + '/data_dict.npy', self.data_dict)
        print('Data saved in: ', self.data_dir)
