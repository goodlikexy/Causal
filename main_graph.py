from datasets import linear, multiple_lotka_volterra, graph
import logging
import os
from models import rootad
from args import linear_point_args, lv_point_args, graph_point_args
import sys
...
def main(argv):
    ...
    log_file_path = os.path.join(logging_dir, 'graph.log')
    # Set up logging
    ...
    parser = graph_point_args.args_parser()
    ...
    data_class = graph.GraphTimeSeriesGenerator(options)
