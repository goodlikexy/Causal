...
from utils.utils import construct_training_dataset
...
from utils.plotting_utils import plot_stability
...
def training_procedure(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                       ...
                       beta_2=0.999, use_cuda='cuda:0', verbose=True, test_data=None, pretrained_senn=None, pretrained_optim=None):
    """
    ...
    with torch.no_grad():
        ...
        if test_data is not None:
            ...
            return causal_struct_estimate, coeffs.cpu().numpy(), mse_test, senn
        else:
            return causal_struct_estimate, coeffs.cpu().numpy(), senn, optimiser


def training_procedure_stable(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                              gamma: float, seed=42, num_hidden_layers=1, initial_learning_rate=0.001, beta_1=0.9,
                              beta_2=0.999, Q=20, use_cuda='cuda:0', verbose=True, display=False):
    """
    ...
    a_hat_1, coeffs_full_1, _, _ = training_procedure(data=[data_1], order=order, hidden_layer_size=hidden_layer_size,
    ...
    a_hat_2, coeffs_full_2, _, _ = training_procedure(data=[data_2], order=order, hidden_layer_size=hidden_layer_size,
                                                end_epoch=end_epoch, lmbd=lmbd, gamma=gamma, batch_size=batch_size,
                                                seed=seed, num_hidden_layers=num_hidden_layers,
                                                initial_learning_rate=initial_learning_rate, beta_1=beta_1,
                                                beta_2=beta_2, use_cuda=use_cuda, verbose=False)
    ...
    a_hat, coeffs_full, _, _ = training_procedure(data=data, order=order, hidden_layer_size=hidden_layer_size,
                                            end_epoch=end_epoch, lmbd=lmbd, gamma=gamma, batch_size=batch_size,
                                            seed=seed, num_hidden_layers=num_hidden_layers,
                                            initial_learning_rate=initial_learning_rate, beta_1=beta_1,
                                            beta_2=beta_2, use_cuda=use_cuda, verbose=False)
...
def training_procedure_trgc(data, order: int, hidden_layer_size: int, end_epoch: int, batch_size: int, lmbd: float,
                            gamma: float, seed=42, num_hidden_layers=1, initial_learning_rate=0.001, beta_1=0.9,
                            beta_2=0.999, Q=20, use_cuda='cuda:0', verbose=True, display=False, true_struct=None,
                            signed=False, pretrained_senn=None, pretrained_optim=None,
                            pretrained_senn_2=None, pretrained_optim_2=None):
    """
    ...
    if verbose:
        ...
        print("Training model #1...")
    a_hat_1, coeffs_full_1, senn, optim = training_procedure(data=[data_1], order=order, hidden_layer_size=hidden_layer_size,
                                                end_epoch=end_epoch, lmbd=lmbd, gamma=gamma, batch_size=batch_size,
                                                seed=seed, num_hidden_layers=num_hidden_layers,
                                                initial_learning_rate=initial_learning_rate, beta_1=beta_1,
                                                beta_2=beta_2, use_cuda=use_cuda, verbose=False,
                                                pretrained_senn=pretrained_senn, pretrained_optim=pretrained_optim)
    if verbose:
        print("Training model #2...")
    a_hat_2, coeffs_full_2, senn_2, optim_2 = training_procedure(data=[data_2], order=order, hidden_layer_size=hidden_layer_size,
                                                end_epoch=end_epoch, lmbd=lmbd, gamma=gamma, batch_size=batch_size,
                                                seed=seed, num_hidden_layers=num_hidden_layers,
                                                initial_learning_rate=initial_learning_rate, beta_1=beta_1,
                                                beta_2=beta_2, use_cuda=use_cuda, verbose=False,
                                                pretrained_senn=pretrained_senn_2, pretrained_optim=pretrained_optim_2)
